...
// Abstracted form reading functionality into function
function collectRequestBodyData(request, callback) {
    if(request.headers['content-type'] === 'application/x-www-form-urlencoded') { // Só nestes casos é que se pode ir buscar ao body a informação desta forma
        let body = '';
