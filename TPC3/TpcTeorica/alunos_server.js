...
var static_resources = fs.readdirSync('./public/')
console.log(static_resources)
// Server creation
...
var alunosServer = http.createServer(function (req, res) {
    ...
    // Handling request
    if(static.staticResource(req, static_resources)){ // Recurso estático
        ...
        switch(req.method){
                ...
                // GET /alunos/:id --------------------------------------------------------------------
                    ...
                    axios.get("http://localhost:3000/alunos/" + idAluno)
                        .then( response => {
                            ...
                            res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                            res.end(templates.studentPages(a, d))
                        })
                }
                // GET /alunos/registo --------------------------------------------------------------------
            ...
            case "POST":
                if(req.url == '/alunos'){
                    res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                    res.end(templates.studentFormPageTemplate(d))
                }
                else{
                    res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
